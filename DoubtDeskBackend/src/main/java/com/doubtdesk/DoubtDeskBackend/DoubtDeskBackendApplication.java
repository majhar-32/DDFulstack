...
public class DoubtDeskBackendApplication {
	...
	CommandLineRunner initDatabase(CourseRepository courseRepository) {
		return args -> {
			// ফ্রন্টএন্ডের initialCoursesData এর সাথে মিলিয়ে কোর্স তৈরি করা হচ্ছে
			...
			course1.setDuration("1 Year"); // একটি আনুমানিক মান
			...
			// শুধুমাত্র যদি কোনো কোর্স না থাকে, তবেই এগুলো সেভ করা হবে
